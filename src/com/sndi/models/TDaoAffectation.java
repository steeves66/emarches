...
public class TDaoAffectation implements java.io.Serializable {
	...
	@AttributeOverrides({
			@AttributeOverride(name = "dafId", column = @Column(name = "DAF_ID", nullable = false, precision = 10, scale = 0)),
			...
			@AttributeOverride(name = "dafTypePlan", column = @Column(name = "DAF_TYPE_PLAN", length = 4)),
			@AttributeOverride(name = "dafDacStr", column = @Column(name = "DAF_DAC_STR", length = 20)),
			@AttributeOverride(name = "dafDacRecherche", column = @Column(name = "DAF_DAC_RECHERCHE", length = 4000)) })
