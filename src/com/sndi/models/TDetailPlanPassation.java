...
public class TDetailPlanPassation implements java.io.Serializable {
	...
	private TDetailPlanPassationId id;

	public TDetailPlanPassation() {
	}

	public TDetailPlanPassation(TDetailPlanPassationId id) {
		this.id = id;
	}
	...
	public TDetailPlanPassationId getId() {
		return this.id;
	}

	public void setId(TDetailPlanPassationId id) {
		this.id = id;
	}
