...
/**
 * VCompoCommissionId generated by hbm2java
 */
@Embeddable
public class VCompoCommissionId implements java.io.Serializable {
	...
	public VCompoCommissionId() {
	}

	public VCompoCommissionId(String strCode, String tctCode) {
		this.strCode = strCode;
		this.tctCode = tctCode;
	}

	public VCompoCommissionId(String strCode, String tctCode, String tctLibelle, String tctTitre, String tctTstCode,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VCompoCommissionId))
			return false;
		VCompoCommissionId castOther = (VCompoCommissionId) other;
		...
		return ((this.getStrCode() == castOther.getStrCode()) || (this.getStrCode() != null
				...
				&& ((this.getTctCode() == castOther.getTctCode()) || (this.getTctCode() != null
