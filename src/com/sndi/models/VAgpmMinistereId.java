...
/**
 * VAgpmMinistereId generated by hbm2java
 */
@Embeddable
public class VAgpmMinistereId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VAgpmMinistereId))
			return false;
		VAgpmMinistereId castOther = (VAgpmMinistereId) other;
