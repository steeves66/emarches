...
/**
 * VModeleAmiId generated by hbm2java
 */
@Embeddable
public class VModeleAmiId implements java.io.Serializable {
	...
	public VModeleAmiId(long gpgId, String mdtCode) {
		this.gpgId = gpgId;
		this.mdtCode = mdtCode;
	}

	public VModeleAmiId(long gpgId, String mdtCode, String mdtLibelleLong, String mdtLibelleCourt, Date mdtDteSaisi,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VModeleAmiId))
			return false;
		VModeleAmiId castOther = (VModeleAmiId) other;
