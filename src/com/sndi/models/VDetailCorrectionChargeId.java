...
/**
 * VDetailCorrectionChargeId generated by hbm2java
 */
@Embeddable
public class VDetailCorrectionChargeId implements java.io.Serializable {
	...
	public VDetailCorrectionChargeId() {
	}

	public VDetailCorrectionChargeId(BigDecimal pidCode) {
		this.pidCode = pidCode;
	}

	public VDetailCorrectionChargeId(BigDecimal pidCode, String pidLibelle, String dcoDacCode, String dcoPresente,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VDetailCorrectionChargeId))
			return false;
		VDetailCorrectionChargeId castOther = (VDetailCorrectionChargeId) other;
