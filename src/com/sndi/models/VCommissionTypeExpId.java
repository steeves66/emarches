...
/**
 * VCommissionTypeExpId generated by hbm2java
 */
@Embeddable
public class VCommissionTypeExpId implements java.io.Serializable {
	...
	public VCommissionTypeExpId() {
	}

	public VCommissionTypeExpId(String tctCode) {
		this.tctCode = tctCode;
	}

	public VCommissionTypeExpId(String tctCode, String tctLibelle, String tctTitre, String tctTstCode,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VCommissionTypeExpId))
			return false;
		VCommissionTypeExpId castOther = (VCommissionTypeExpId) other;
