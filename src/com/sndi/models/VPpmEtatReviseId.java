...
/**
 * VPpmEtatReviseId generated by hbm2java
 */
@Embeddable
public class VPpmEtatReviseId implements java.io.Serializable {
	...
	public VPpmEtatReviseId(long dppId, long dppPlpId, long dppGpgId, String dppStaCode, String dppTymCode,
			String dppMopCode, String dppTypePlan, String lbgCode, String lbgImputation, String tymLibelleCourt,
			short plpGesCode) {
		this.dppId = dppId;
	...
	public VPpmEtatReviseId(BigDecimal VId, long dppId, long dppPlpId, long dppGpgId, String dppStaCode,
			...
			Date dppDateOuvertOf, Date dppDateElabRapport, Date dppDateJugementOffre, Date dppDateAttApprobDmp,
			Date dppDateAttApproBail, Date dppDateNegociation, Date dppDateSignatAttrib, Date dppDateSignatAc,
			Date dppDateMarcheApprob, Date dppDateExecDebut, Date dppDateExecFin, String dppActeurSaisie,
	...
	@Column(name = "NAT_CODE", length = 20)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VPpmEtatReviseId))
			return false;
		VPpmEtatReviseId castOther = (VPpmEtatReviseId) other;
