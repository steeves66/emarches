...
/**
 * VLotId generated by hbm2java
 */
@Embeddable
public class VLotId implements java.io.Serializable {
	...
	public VLotId(BigDecimal laaId) {
		this.laaId = laaId;
	}

	public VLotId(BigDecimal laaId, String laaAaoCode, String laaObjet, String laaObservation, BigDecimal laaMtCaut,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VLotId))
			return false;
		VLotId castOther = (VLotId) other;
