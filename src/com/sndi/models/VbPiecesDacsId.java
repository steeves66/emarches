...
/**
 * VbPiecesDacsId generated by hbm2java
 */
@Embeddable
public class VbPiecesDacsId implements java.io.Serializable {
	...
	public VbPiecesDacsId(BigDecimal pidCode) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VbPiecesDacsId))
			return false;
		VbPiecesDacsId castOther = (VbPiecesDacsId) other;
