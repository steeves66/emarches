...
public class TDetailAdresseAvis implements java.io.Serializable {
	...
	private TDetailAdresseAvisId id;

	public TDetailAdresseAvis() {
	}

	public TDetailAdresseAvis(TDetailAdresseAvisId id) {
		this.id = id;
	}
	...
	public TDetailAdresseAvisId getId() {
		return this.id;
	}

	public void setId(TDetailAdresseAvisId id) {
		this.id = id;
	}
