...
/**
 * VbDossierPlanGeneralId generated by hbm2java
 */
@Embeddable
public class VbDossierPlanGeneralId implements java.io.Serializable {
	...
	public VbDossierPlanGeneralId() {
	}

	public VbDossierPlanGeneralId(long dpgId, String dpgNapCode, long dpgGpgId) {
		this.dpgId = dpgId;
		this.dpgNapCode = dpgNapCode;
		this.dpgGpgId = dpgGpgId;
	}

	public VbDossierPlanGeneralId(long dpgId, String dpgNapCode, long dpgGpgId, String dpgCode, String dpgLibelle,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VbDossierPlanGeneralId))
			return false;
		VbDossierPlanGeneralId castOther = (VbDossierPlanGeneralId) other;
