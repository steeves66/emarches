...
/**
 * VModelePrqId generated by hbm2java
 */
@Embeddable
public class VModelePrqId implements java.io.Serializable {
	...
	public VModelePrqId(long gpgId, String mdtCode) {
		this.gpgId = gpgId;
		this.mdtCode = mdtCode;
	}

	public VModelePrqId(long gpgId, String mdtCode, String mdtLibelleLong, String mdtLibelleCourt, Date mdtDteSaisi,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VModelePrqId))
			return false;
		VModelePrqId castOther = (VModelePrqId) other;
