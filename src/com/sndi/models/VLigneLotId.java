...
/**
 * VLigneLotId generated by hbm2java
 */
@Embeddable
public class VLigneLotId implements java.io.Serializable {
	...
	public VLigneLotId(String lbgCode, String lbgStrCode, short lbgGesCode, BigDecimal lbgResDon, String lbgImputation,
	...
	public VLigneLotId(String dppDacCode, String lbgCode, String lbgStrCode, short lbgGesCode, BigDecimal lbgResDon,
			...
			String natLibelle, String dacCode) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VLigneLotId))
			return false;
		VLigneLotId castOther = (VLigneLotId) other;

		return ((this.getDppDacCode() == castOther.getDppDacCode()) || (this.getDppDacCode() != null
