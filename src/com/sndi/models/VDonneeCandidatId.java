...
/**
 * VDonneeCandidatId generated by hbm2java
 */
@Embeddable
public class VDonneeCandidatId implements java.io.Serializable {
	...
	public VDonneeCandidatId() {
	}

	public VDonneeCandidatId(String dacCode, long canCode, String dveDacCode) {
		this.dacCode = dacCode;
		this.canCode = canCode;
		this.dveDacCode = dveDacCode;
	}

	public VDonneeCandidatId(String dacCode, long canCode, String canTieNcc, String canSouNcc, String canNomResp,
			String canNom, String canPrenoms, String canTel, Date canDteSaisi, String canOpeMatricule, String canEmail,
			String dveDacCode) {
		this.dacCode = dacCode;
		this.canCode = canCode;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VDonneeCandidatId))
			return false;
		VDonneeCandidatId castOther = (VDonneeCandidatId) other;
		...
		return ((this.getDacCode() == castOther.getDacCode()) || (this.getDacCode() != null
				...
				&& (this.getCanCode() == castOther.getCanCode())
				...
				&& ((this.getDveDacCode() == castOther.getDveDacCode())
						|| (this.getDveDacCode() != null && castOther.getDveDacCode() != null
								&& this.getDveDacCode().equals(castOther.getDveDacCode())));
	}
