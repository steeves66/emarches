...
public class TPiecesOffres implements java.io.Serializable {
	...
	private TPiecesOffresId id;

	public TPiecesOffres() {
	}

	public TPiecesOffres(TPiecesOffresId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "pofAdd", column = @Column(name = "POF_ADD", precision = 22, scale = 0)) })
	public TPiecesOffresId getId() {
		return this.id;
	}

	public void setId(TPiecesOffresId id) {
		this.id = id;
	}
