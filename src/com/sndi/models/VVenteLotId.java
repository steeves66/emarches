...
/**
 * VVenteLotId generated by hbm2java
 */
@Embeddable
public class VVenteLotId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VVenteLotId))
			return false;
		VVenteLotId castOther = (VVenteLotId) other;
