...
public class TDetailPlanGeneral implements java.io.Serializable {
	...
	private TDetailPlanGeneralId id;

	public TDetailPlanGeneral() {
	}

	public TDetailPlanGeneral(TDetailPlanGeneralId id) {
		this.id = id;
	}
	...
	public TDetailPlanGeneralId getId() {
		return this.id;
	}

	public void setId(TDetailPlanGeneralId id) {
		this.id = id;
	}
