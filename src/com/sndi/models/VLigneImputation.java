 ...
 */
@Entity
@Table(name = "V_LIGNE_IMPUTATION", schema = "EMAP")
public class VLigneImputation implements java.io.Serializable {

	private VLigneImputationId id;

	public VLigneImputation() {
	}

	public VLigneImputation(VLigneImputationId id) {
		this.id = id;
	}
	...
	public void setId(VLigneImputationId id) {
		this.id = id;
	}
