 ...
 */
@Entity
@Table(name = "V_LIGNE_LOT", schema = "EMAP")
public class VLigneLot implements java.io.Serializable {

	private VLigneLotId id;

	public VLigneLot() {
	}

	public VLigneLot(VLigneLotId id) {
		this.id = id;
	}

	@EmbeddedId

	@AttributeOverrides({ @AttributeOverride(name = "dppDacCode", column = @Column(name = "DPP_DAC_CODE", length = 20)),
	...
	public VLigneLotId getId() {
		return this.id;
	}

	public void setId(VLigneLotId id) {
		this.id = id;
	}
