...
/**
 * VbGestionId generated by hbm2java
 */
@Embeddable
public class VbGestionId implements java.io.Serializable {
	...
	public VbGestionId(short gesCode) {
		this.gesCode = gesCode;
	}

	public VbGestionId(short gesCode, Date gesDateDebut, Date gesDateFin) {
		this.gesCode = gesCode;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VbGestionId))
			return false;
		VbGestionId castOther = (VbGestionId) other;
