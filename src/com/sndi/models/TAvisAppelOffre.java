 ...
 */
@Entity
@Table(name = "T_AVIS_APPEL_OFFRE", schema = "EMAP", uniqueConstraints = @UniqueConstraint(columnNames = "AAO_NUM_SEQ"))
public class TAvisAppelOffre implements java.io.Serializable {
	...
	public TAvisAppelOffre(String aaoCode, String aaoLibelle, String aaoDacCode, Date aaoDteSaisi, String aaoStaCode,
	...
	@Column(name = "AAO_CODE", unique = true, nullable = false, length = 22)
	...
	@Column(name = "AAO_NUM_SEQ", unique = true, length = 22)
