...
public class TTempParametre implements java.io.Serializable {
	...
	private TTempParametreId id;

	public TTempParametre() {
	}

	public TTempParametre(TTempParametreId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "tempChamp26", column = @Column(name = "TEMP_CHAMP_26", length = 500)),
			@AttributeOverride(name = "tempChamp27", column = @Column(name = "TEMP_CHAMP_27", length = 500)),
			@AttributeOverride(name = "tempChamp28", column = @Column(name = "TEMP_CHAMP_28", length = 500)),
			@AttributeOverride(name = "tempChamp29", column = @Column(name = "TEMP_CHAMP_29", length = 1)),
			@AttributeOverride(name = "tempChamp30", column = @Column(name = "TEMP_CHAMP_30", length = 500)),
			@AttributeOverride(name = "tempChamp31", column = @Column(name = "TEMP_CHAMP_31", length = 500)),
			@AttributeOverride(name = "tempChamp32", column = @Column(name = "TEMP_CHAMP_32", length = 500)),
			@AttributeOverride(name = "tempDteSea", column = @Column(name = "TEMP_DTE_SEA", length = 7)),
			@AttributeOverride(name = "tempHeureDeb", column = @Column(name = "TEMP_HEURE_DEB", length = 500)),
			@AttributeOverride(name = "tempHeureFin", column = @Column(name = "TEMP_HEURE_FIN", length = 500)),
			@AttributeOverride(name = "tempNb", column = @Column(name = "TEMP_NB", precision = 22, scale = 0)) })
	public TTempParametreId getId() {
		return this.id;
	}

	public void setId(TTempParametreId id) {
		this.id = id;
	}
