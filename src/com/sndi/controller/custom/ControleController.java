...
public class ControleController {
	...
	private boolean btn_save_pgspm =false;
	private boolean btn_save_pgpm =false; 
			   ...
			   panelAgpmTableauBordVal = false;
		    	...
		    	if(action.equalsIgnoreCase("MOD")) {
		    		...
		    		if(action.equalsIgnoreCase("LIS")) {
		    			libelle1="Index";
		    			libelle="SAISIE DES AVIS GENEREAUX DE PASSATION DE MARCHES";	
		    			 btn_new =true;
						 panel1 =true;
						 panel2 =false;
						 fermerSai=true;
		    			...
		    			if(action.equalsIgnoreCase("VAL")) {
		    				libelle="VALIDATION DES AVIS GENEREAUX DE PASSATION DE MARCHES";	
		    				panelDetail=false;
		    				panelForm=false;
	...
	//Redirection en fonction du traitement a éffectuer
		 public String redirectionDynamicProcedures(String action) {
			 ...
			 if(action.equalsIgnoreCase("ENGAMI")) {
				 type = "AMI";
				  libelleAmi="SAISIE D'UN AMI";
			       libelleAmi1="Liste des AMI Saisis par l'autorité Contractante";
			       libelle1="Saisie d'une nouveau AMI";
	    			
	    		   libelleDao1="SAISIE D'UN NOUVEL AVIS A MANIFESTATION D'INTERET";
	    		   libellesmall="Nouveau AMI";
			       panelDetail=false;
				   panelForm=true;
				   panelTraitement=false;
			       panelRegister=true;
			       ...
			       btn_fermer_saisie_prq = false;                      
			    	...
			    	if(action.equalsIgnoreCase("MODAMI")) {
			    		...
			    		if(action.equalsIgnoreCase("SAIAMI")) {
			    			type = "AMI";
			    			libelle1="Index";
			    			libelleAmi = "SAISIE D'UN NOUVEL AVIS A MANIFESTATION D'INTERET";
			    			 btn_new =true;
							 panel1 =true;
							 panel2 =false;
							 panelAmiTableauBordSai = true;
							 panelAmiTableauBordVal = false;
							 panelAmi = true;
							 panelDao = false;  
							 panelPrq = false;
							 btn_trans_ami =true;
			    			...
			    			if(action.equalsIgnoreCase("VALAMI")) {
			    				type = "AMI";
			    				libelleAmi = "VALIDATION DES AVIS A MANIFESTATION D'INTERET";
			    				libelleAmi1="Liste des AMI en attente de validation";
			    				panelDetail=false;
			    				panelForm=false;
			   				    panelTraitement=true;
			    				btn_new =false;
								...
								btn_trans_dao =false;
								btn_trans_prq =false;
								panelAmiTableauBordSai = false;
								panelAmiTableauBordVal = true;
								panelDao = false;
								panelPrq =false;
								panelAmi = true;
								fermerValAmi =true;
								...
								btn_valider_prq_cpmp = false;
								btn_valider_prq_dmp = false; 
								btn_valider_ami_cpmp = true; 
								btn_valider_ami_dmp = true;
								btn_valider_dao_cpmp = false;
								btn_valider_dao_dmp = false;
								btn_fermer_saisie_ami = true; 
								btn_fermer_saisie_prq = false;
			       ...
			       btn_fermer_saisie_prq = false  ;                     
			    	...
			    	if(action.equalsIgnoreCase("MODDAO")) {
			    		...
			    		if(action.equalsIgnoreCase("SAIDAO")) {
			    			type = "DAC";
			    			libelle1="Index";
			    			libelleDao3="SAISIE D'UN NOUVEAU DOSSIER D'APPEL A CONCURRENCE";
			    			 btn_new =true;
			    			 btn_affec = false;
							 panel1 =true;
							 panel2 =false;
				    								   ...
				    								   if(action.equalsIgnoreCase("PUBDAO")) {
				    									     ...
				    									     if(action.equalsIgnoreCase("TRADAO")) {
				    									    	 ...
				    									    	 if(action.equalsIgnoreCase("RETDAO")) {
																	 ...
																	 panelDaoTableauBordPub = false;
																	 panelDaoTableauBordPrise = false;
																	 setPanelDaoTableauBordPrise(true);
																	 panelDao = true;  
																	 panelPrq = false;
																	 btn_trans_ami =false;
																	 btn_trans_dao =false;
			 ...
			 if(action.equalsIgnoreCase("ENGPRQ")) {
				 ...
				 libelleAmi="SAISIE D'UNE PREQUALIFICATION";
			       libelleAmi1="Liste des préqualifications Saisis par l'autorité Contractante";
			       libelle1="Saisie d'une nouvelle préqualification";
	    			
	    			libelleDao1="SAISIE D'UNE NOUVELLE PREQUALIFICATION";
	    			libellesmall="Nouvelle préqualification";
				 libellePrq1="SAISIE D'UNE PREQUALIFICATION";
			       libelleAmi1="Liste Préqualifications Saisies par l'autorité Contractante";
			       panelDetail=false;
				   panelForm=true;
				   panelTraitement=false;
			       panelRegister=true;
			       ...
			       btn_fermer_saisie_prq = true;                       
			    	...
			    	if(action.equalsIgnoreCase("MODPRQ")) {
			    		...
			    		libelleProcedure="Modification de la Préqualification N°";
			    		libelleP = "Modification";
			    		panelDetail=false;
					    panelForm=true;
					    panelTraitement=false;
			    		panelUpdate=true;
			    		...
			    		if(action.equalsIgnoreCase("SAIPRQ")) {
			    			...
			    			if(action.equalsIgnoreCase("VALPRQ")) {
			    				type = "Préqualification";
			    				libelleValPrq = "VALIDATION DES PREQUALIFICATIONS";
			    				panelDetail=false;
			    				panelForm=false;
			   				    panelTraitement=true;
			    				btn_new =false;
								panel1 =false;
								panel2 =true;
								panelPrqTableauBordSai = false;
								panelPrqTableauBordVal = true;
								panelDao = false;
								panelPrq =true ; 
								panelAmi = false;
								fermerValPrq =true;
								...
								btn_trans_dao =false;
								btn_trans_prq =false;
								btn_valider_prq_cpmp = true;
								btn_valider_prq_dmp = true;  
								btn_valider_ami_cpmp = false;  
								btn_valider_ami_dmp = false;
								btn_valider_dao_cpmp = false;
								btn_valider_dao_dmp = false;
				    			...
				    			if(action.equalsIgnoreCase("APEPRQ")) {
				    				...
				    				panelForm=false;
				   				    panelTraitement=false;
				    				libelle1="Synthèse";
				    				libelle2 = "Synthèse de la Préqualification N°";
				    				fermerSaiPrq = true; 
				    				fermerValPrq = false;
				    				fermerSaiAmi = false;  
				    				fermerValAmi = false;
