...
public class ControleController {
	...
	public boolean btnDejPub = false;
	...
	private boolean btnRetourAffecte = false;
			    		...
			    		if(action.equalsIgnoreCase("SAIDAO")) {
				    		...
				    		if(action.equalsIgnoreCase("SAIDAO")) {
					    		...
					    		if(action.equalsIgnoreCase("RATTRA")) {
					    			...
					    			libelleDao3="MODIFICATION DES DOSSIERS D'APPEL D'OFFRES";
					    			libelleSmall="Les DAC à rattraper";
					    			btn_daoPn =false;
					    			btn_daoPs =false;
					    			btn_ami =false;
					    			btn_prq =false;
					    				 ...
					    				 if(action.equalsIgnoreCase("DOSAFF")) {
					    					 typePlan ="PN";
					    				        ...
					    				        libelle1="LISTE DES DOSSIERS DEJA AFFECTES";
								    			 ...
								    			 libelleSmall = "Dossiers déjà affectés";
								    			 libelleA = "DAO";
								    			 btn_new =false;
								    			 btn_reaffectation = false;
								    			 btn_affec = true;
								    			 btnRetourAffecte = true;
								    			 btn_exam = false;
								    			 btn_retrait = false;
								    			 btn_valid = false;
								    			 panel1 =true;
				    								   ...
				    								   if(action.equalsIgnoreCase("PUBDAO")) {
					    								   ...
					    								   if(action.equalsIgnoreCase("DPUBDAO")) {
					    									    typePlan ="PN";
					    									     ...
					    									     btn_pub =true;
					    									     libelle1="LISTE DES DAO EN PROCEDURE NORMALE";
												    			 libelleDao3="DOSSIER(S) D'APPEL D'OFFRES PUBLIE(S)";
												    			 btn_new =false;
												    			 btn_affec = false;
												    			 btn_exam = false;
												    			 btn_retrait = false;
	...
	public boolean isBtn_rat() {
		return btn_rat;
	}


	public void setBtn_rat(boolean btn_rat) {
		this.btn_rat = btn_rat;
	}


	public boolean isBtn_rat_mod() {
		return btn_rat_mod;
	}
	...
	public boolean isBtnRetourAffecte() {
		return btnRetourAffecte;
	}


	public void setBtnRetourAffecte(boolean btnRetourAffecte) {
		this.btnRetourAffecte = btnRetourAffecte;
	}


	public boolean isBtnDejPub() {
		return btnDejPub;
	}
