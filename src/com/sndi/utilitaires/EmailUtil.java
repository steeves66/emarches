...
public class EmailUtil {
	...
	public static void sendEmail(Session session, String toEmail,String ccEmail, String subject, String body){
		try
	    {
	      ...
	      msg.addRecipient(RecipientType.CC, new InternetAddress(ccEmail, ""));
