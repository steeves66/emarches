...
// Generated 17 août 2020 11:44:50 by Hibernate Tools 4.3.5.Final
...
/**
 * VbTempCritereId generated by hbm2java
 */
@Entity
@Immutable
@Table(name = "VB_TEMP_CRITERE")
public class VbTempCritere implements java.io.Serializable {
	...
	public VbTempCritere() {
	}

	public VbTempCritere(BigDecimal craNum) {
		this.craNum = craNum;
	}

	public VbTempCritere(BigDecimal craNum, String craType, String craOpeMatricule, Date craDteSaisi,
			String craDacCode) {
		this.craNum = craNum;
