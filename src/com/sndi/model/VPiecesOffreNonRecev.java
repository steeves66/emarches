...
// Generated 27 nov. 2020 18:49:20 by Hibernate Tools 4.3.5.Final
...
/**
 * VPiecesOffreNonRecevId generated by hbm2java
 */
@Entity
@Immutable
@Table(name = "V_PIECES_OFFRE_NON_RECEV")
public class VPiecesOffreNonRecev implements java.io.Serializable {
	...
	public VPiecesOffreNonRecev() {
	}

	public VPiecesOffreNonRecev(BigDecimal dofNum) {
		this.dofNum = dofNum;
	}

	public VPiecesOffreNonRecev(BigDecimal pofNum, String craCode, BigDecimal dofNum, BigDecimal dcadNum,
			String analyseStatut, BigDecimal dcadLaaId, String pofLibelle, String laaAaoCode, String pofConforme,
			Long pofScore, String pofObs, String anfPresence, BigDecimal anfNum, String dcadDacCode,
			BigDecimal btnAnfValeurConf, BigDecimal btnAnfPresence) {
		this.pofNum = pofNum;
