...
// Generated 22 juil. 2020 16:05:54 by Hibernate Tools 4.3.5.Final
...
/**
 * VCommissionSpecialeId generated by hbm2java
 */
@Entity
@Immutable
@Table(name = "V_COMMISSION_SPECIALE")
public class VCommissionSpeciale implements java.io.Serializable {
	...
	public VCommissionSpeciale() {
	}

	public VCommissionSpeciale(String tctCode) {
		this.tctCode = tctCode;
	}

	public VCommissionSpeciale(String tctCode, String tctLibelle, String tctTitre, String tctTstCode,
