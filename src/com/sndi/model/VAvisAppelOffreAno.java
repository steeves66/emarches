...
// Generated 21 sept. 2020 11:45:34 by Hibernate Tools 4.3.5.Final
...
/**
 * VAvisAppelOffreAnoId generated by hbm2java
 */
@Entity
@Immutable
@Table(name = "V_AVIS_APPEL_OFFRE_ANO")
public class VAvisAppelOffreAno implements java.io.Serializable {
	...
	public VAvisAppelOffreAno(String aaoCode) {
		this.aaoCode = aaoCode;
	}

	public VAvisAppelOffreAno(String aaoCode, String aaoDacCode, String aaoLibelle, BigDecimal aaoNbrLot,
	...
	public Character getAaoStatut() {
		return this.aaoStatut;
	}

	public void setAaoStatut(Character aaoStatut) {
		this.aaoStatut = aaoStatut;
	}
