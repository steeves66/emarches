...
public class VDacliste implements java.io.Serializable {
	...
	public VDacliste(String dacCode, String dacObjet, Date dacDteSaisi, String dacStaCode, String dacTymCode,
			...
			Date dacDateAvisBailleur, String dacBailleur, Long dacCout, String dacTypePlan,Long dacNbreAchat, String dacAutComSpec,String dacRecherche,
	...
	public String getDacMentionAffecte() {
		return this.dacMentionAffecte;
	}

	public void setDacMentionAffecte(String dacMentionAffecte) {
		this.dacMentionAffecte = dacMentionAffecte;
	}

	@Column(name = "CHECK_COR", precision = 22, scale = 0)
	public BigDecimal getCheckCor() {
		return this.checkCor;
	}
