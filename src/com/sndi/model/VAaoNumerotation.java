...
// Generated 16 juil. 2021 08:23:13 by Hibernate Tools 4.3.5.Final
...
/**
 * VAaoNumerotationId generated by hbm2java
 */
@Entity
@Immutable
@Table(name = "V_AAO_NUMEROTATION")
public class VAaoNumerotation implements java.io.Serializable {
	...
	public VAaoNumerotation() {
	}

	public VAaoNumerotation(String aaoCode) {
		this.aaoCode = aaoCode;
	}

	public VAaoNumerotation(String aaoCode, String aaoLibelle, String aaoDacCode, Date aaoDteSaisi, String aaoStaCode,
			...
			String aaoNumBompPub, Date aaoDteBompPub, String aaoArtComSpec, String aaoMessCritLotExist,
			BigDecimal aaoStatut, String aaoOffAnormal) {
		this.aaoCode = aaoCode;
