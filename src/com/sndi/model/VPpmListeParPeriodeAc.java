...
// Generated 21 avr. 2021 13:54:53 by Hibernate Tools 4.3.5.Final
...
/**
 * VPpmListeParPeriodeAcId generated by hbm2java
 */
@Entity
@Immutable
@Table(name = "V_PPM_LISTE_PAR_PERIODE_AC")
public class VPpmListeParPeriodeAc implements java.io.Serializable {
	...
	private BigDecimal dppNbOuv;
	private BigDecimal cptFinancement;
	private String fonCodeSpp;
	private String fonCodeDmp;
	private String critere;

	public VPpmListeParPeriodeAc() {
	}

	public VPpmListeParPeriodeAc(long dppId, String dppStaCode, String dppMopCode, String mopLibelleCourt,
			String strLibelleCourt, String dppTypePlan, String tymLibelleCourt, long plpId, short plpGesCode) {
		this.dppId = dppId;
	...
	public VPpmListeParPeriodeAc(long dppId, Date dppDteModif, String dppObjet, String dppSourceFin,
			String dppLbgCode, String dppStaCode, String dppMopCode, String mopLibelleCourt, String mopLibelleLong,
			String dppStrCode, String strTstCode, String strLibelleCourt, String strLibelleLong, String lbgFonCodePf,
			String lbgFonCodeAc, String lbgFonCodeCf, String lbgFonCodeCor, String lbgImputation, BigDecimal lbgTotDot,
			BigDecimal lbgDisTot, BigDecimal lbgAeTr, String lbgFonCodeVal, Date dppDateValAc, Date dppDateValCpmp,
			Date dppDateValDmp, String dppPartiePmePmi, Date dppDateSaisie, String dppDacCode, String dppTypePlan,
			String tymLibelleCourt, String dppStatutRetour, String dppStructureConduc, String dppStructureBenefi,
			String dppRecherche, String dppFonCodPf, String dppFonCodDmp, String dppActeurSaisie,
			Date dppDateAttApprobCpmp, Date dppDateAvisAoPublication, Date dppDateDaoApprobBail,
			Date dppDateDaoApprobDmp, Date dppDateDaoTrans, Date dppDateElabRapport, Date dppDateJugementOffre,
			Date dppDateJugementOffreTec, Date dppDateNotAtt, Date dppDateOuvertOf, Date dppDateOuvertOt,
			Date dppDateRecepFact, Date dppDateRecepLettr, Date dppDateSolFact, Date dppInvEntre, Date dppDateExecDebut,
			Date dppDateExecFin, Date dppDateSignatAc, Date dppDateSignatAttrib, Date dppApprobAno,
			Date dppDateNegociation, Date dppDateMarcheApprob, Date dppDateAttApproBail, long plpId, short plpGesCode,
			BigDecimal dppNbOuv, BigDecimal cptFinancement, String fonCodeSpp, String fonCodeDmp, String critere) {
		this.dppId = dppId;
	...
	@Column(name = "DPP_NB_OUV", precision = 22, scale = 0)
	public BigDecimal getDppNbOuv() {
		return this.dppNbOuv;
	}

	public void setDppNbOuv(BigDecimal dppNbOuv) {
		this.dppNbOuv = dppNbOuv;
	}

	@Column(name = "CPT_FINANCEMENT", precision = 22, scale = 0)
	public BigDecimal getCptFinancement() {
		return this.cptFinancement;
	}

	public void setCptFinancement(BigDecimal cptFinancement) {
		this.cptFinancement = cptFinancement;
	}
	...
	@Column(name = "FON_CODE_DMP", length = 30)
	...
	@Column(name = "CRITERE", length = 2077)
