...
@Entity
@Immutable
@Table(name = "V_DETAIL_CORRECTION_CHARGE")
public class VDetailCorrectionCharge implements java.io.Serializable {
	...
	public VDetailCorrectionCharge(Long pidCode) {
		this.pidCode = pidCode;
	}

	public VDetailCorrectionCharge(Long pidCode, String pidLibelle, String dcoDacCode, String dcoPresente,
