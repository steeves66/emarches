...
// Generated 7 sept. 2020 17:41:56 by Hibernate Tools 4.3.5.Final
...
/**
 * VLotAnalyseFinId generated by hbm2java
 */
@Entity
@Immutable
@Table(name = "V_LOT_ANALYSE_FIN")
public class VLotAnalyseFin implements java.io.Serializable {

	private Character lotStatut;
	private String nbtrt;
	...
	public VLotAnalyseFin() {
	}

	public VLotAnalyseFin(BigDecimal laaId, BigDecimal laaNum) {
		this.laaId = laaId;
		this.laaNum = laaNum;
	}

	public VLotAnalyseFin(Character lotStatut, String nbtrt, BigDecimal laaId, String laaAaoCode, String laaObjet,
			...
			String laaLbgImputation, BigDecimal laaNum, BigDecimal laaCoutLot, String laaDacCode, String laaAjoutPanier,
			Long laaDelaiExe, String laaVariante) {
	...
	@Column(name = "LOT_STATUT", length = 1)
	public Character getLotStatut() {
		return this.lotStatut;
	}

	public void setLotStatut(Character lotStatut) {
		this.lotStatut = lotStatut;
	}

	@Column(name = "NBTRT", length = 83)
	public String getNbtrt() {
		return this.nbtrt;
	}

	public void setNbtrt(String nbtrt) {
		this.nbtrt = nbtrt;
	}
