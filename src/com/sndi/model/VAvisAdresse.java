...
// Generated 26 mars 2020 01:52:18 by Hibernate Tools 4.3.5.Final
...
public class VAvisAdresse implements java.io.Serializable {
	...
	public VAvisAdresse(String aaoCode, BigDecimal adaNum) {
		this.aaoCode = aaoCode;
		this.adaNum = adaNum;
	}

	public VAvisAdresse(String aaoCode, BigDecimal VId, String adaFonCod, BigDecimal adaNum, String liaLibelle,
			String dtaLibelle) {
		this.aaoCode = aaoCode;
		this.VId = VId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VAvisAdresse))
			return false;
		VAvisAdresse castOther = (VAvisAdresse) other;
