...
// Generated 31 août 2020 17:01:29 by Hibernate Tools 4.3.5.Final
...
/**
 * VDetOffreNonRecevableId generated by hbm2java
 */
@Entity
@Immutable
@Table(name = "V_DET_OFFRE_NON_RECEVABLE")
public class VDetOffreNonRecevable implements java.io.Serializable {
	...
	public VDetOffreNonRecevable() {
	}

	public VDetOffreNonRecevable(BigDecimal dofNum, BigDecimal dofLaaId, String dofLaaAaoCode, BigDecimal dofOffNum,
			BigDecimal dofDelai) {
		this.dofNum = dofNum;
	...
	public VDetOffreNonRecevable(BigDecimal dofNum, BigDecimal dofLaaId, String dofLaaAaoCode, BigDecimal dofOffNum,
			...
			String dofOpeMatricule, String dofStatut, String dofSouNcc, String souSigleSte, String laaDacCode,
			String dofTitle, BigDecimal dofErrCalcul, BigDecimal dofMtRab, String dofSigle, String dofErrFin,
	...
	public String getDofTitle() {
		return this.dofTitle;
	}

	public void setDofTitle(String dofTitle) {
		this.dofTitle = dofTitle;
	}
	...
	@Column(name = "DOF_SIGLE", length = 513)
