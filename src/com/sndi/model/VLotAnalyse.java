...
// Generated 12 août 2020 10:23:58 by Hibernate Tools 4.3.5.Final
...
/**
 * VLotAnalyseId generated by hbm2java
 */
@Entity
@Immutable
...
public class VLotAnalyse implements java.io.Serializable {
	...
	public VLotAnalyse(BigDecimal laaId, String laaAaoCode, String laaObjet, String laaObservation,
			...
			BigDecimal laaCoutLot, String laaDacCode, String laaAjoutPanier, Long laaDelaiExe, String laaVariante,BigDecimal lotStatut) {
		this.laaId = laaId;
	...
	@Column(name = "LOT_STATUT", precision = 22, scale = 0)
	public BigDecimal getLotStatut() {
		return this.lotStatut;
	}

	public void setLotStatut(BigDecimal lotStatut) {
		this.lotStatut = lotStatut;
	}
}
