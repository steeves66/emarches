...
// Generated 6 sept. 2021 09:59:49 by Hibernate Tools 4.3.5.Final
...
public class VLotNumerotation implements java.io.Serializable {
	...
	private BigDecimal marDejaNumerote;
	private String marObjet;
	private BigDecimal marMtTotMar;
	private String critere;

	public VLotNumerotation() {
	}

	public VLotNumerotation(BigDecimal attNum, BigDecimal laaId, String laaAaoCode, String laaObjet,
			String attStaCode, BigDecimal laaNum) {
		this.attNum = attNum;
		this.laaId = laaId;
	...
	public VLotNumerotation(BigDecimal attNum, BigDecimal laaId, String laaAaoCode, String laaObjet,
			...
			String laaFonCodSaisi, String laaFonCodCpmp, String laaOpeMatricule, String attStaCode, String laaLieuExe,
			String laaLbgImputation, BigDecimal laaNum, BigDecimal laaCoutLot, String laaDacCode, String attSouNcc,
			BigDecimal attMtAttr, String souSigleSte, Date attDteSaisi, String attFonCodeSaisi, String marCode,
			BigDecimal marDejaNumerote, String marObjet, BigDecimal marMtTotMar, String critere) {
		this.attNum = attNum;
		this.laaId = laaId;
		this.laaAaoCode = laaAaoCode;
		this.laaObjet = laaObjet;
		...
		this.marDejaNumerote = marDejaNumerote;
		this.marObjet = marObjet;
		this.marMtTotMar = marMtTotMar;
	...
	@Column(name = "MAR_CODE", length = 60)
	...
	@Column(name = "MAR_DEJA_NUMEROTE", precision = 22, scale = 0)
	public BigDecimal getMarDejaNumerote() {
		return this.marDejaNumerote;
	}

	public void setMarDejaNumerote(BigDecimal marDejaNumerote) {
		this.marDejaNumerote = marDejaNumerote;
	}

	@Column(name = "MAR_OBJET", length = 1200)
	public String getMarObjet() {
		return this.marObjet;
	}

	public void setMarObjet(String marObjet) {
		this.marObjet = marObjet;
	}

	@Column(name = "MAR_MT_TOT_MAR", precision = 20, scale = 0)
	public BigDecimal getMarMtTotMar() {
		return this.marMtTotMar;
	}

	public void setMarMtTotMar(BigDecimal marMtTotMar) {
		this.marMtTotMar = marMtTotMar;
	}

	@Column(name = "CRITERE", length = 4000)
