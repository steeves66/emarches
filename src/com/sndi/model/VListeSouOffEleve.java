...
/**
 * VListeSouOffEleve generated by hbm2java
 */
@Entity
@Immutable
@Table(name = "V_LISTE_SOU_OFF_ELEVE")
public class VListeSouOffEleve implements java.io.Serializable {
	...
	public VListeSouOffEleve() {
	}

	public VListeSouOffEleve(BigDecimal dofLaaId, BigDecimal dofNum) {
		this.dofLaaId = dofLaaId;
		this.dofNum = dofNum;
	}

	public VListeSouOffEleve(BigDecimal RId, BigDecimal ordre, BigDecimal dofLaaId, BigDecimal laaMtEst,
