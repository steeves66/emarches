...
<head>
    ...
    <title>E-MAP-E-MarchéPublic</title>
            ...
            <section class="col-md-8 content-left">
                <div class="row">
                    <div class="col-md-2 col-xs-6 logo-armoirie">
                     <img src="resources/portail/img/logo.jpg" class="img-responsive" alt="logo primature" style="">
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center footer">
                        <ul class="list-unstyled list-inline">
                         <br/><br/>
                            <li>
                                <a href="http://www.gouv.ci/_cabinet-pm.php?recordID=7">
                                    <br>  ALLER SUR LE PORTAIL DE LA PRIMATURE </a>
                            </li>
                            <li>
